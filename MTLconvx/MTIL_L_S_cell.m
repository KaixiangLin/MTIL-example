...
function [min_rmse,output] = MTIL_L_S_cell(Xtrain,Ytrain,Xtest,Ytest,dataname,timeflag, configurePara)
% clc;  % group lasso on unfolding Q. low rank on W.
% clear;
tic;
...
for  i = 1:lenPara
        ...
        fprintf('-----------MTIL L S--- lambda: %1.2f -- mu:%1.2f ---\n', lambda,mu);

        
        % Learn model

        [W,Q,f] = argmin_lrankW_GLQ_Sparsa_mex_MTLExp_cell(Xtrain, Ytrain, W_ini,Q_ini,lambda, mu, FISTA_options);
